...
<%--头部--%>
    ...
    <div class="row-fluid">
        <div class="span12">
            <img alt="140x140" src="../../product_img/qianru.png" style="width: 100%;height: 300px"/>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="row-fluid">
                <div class="span3">
                    <a href="#" style="color: #333333;">
                        <img alt="140x140" src="../../pro_img/yulei.png" class="img-polaroid" />
                        <p class="text-center">
                            <strong>X型鱼雷通道检查模块</strong>
                        </p>
                    </a>
                </div>
                <div class="span3">
